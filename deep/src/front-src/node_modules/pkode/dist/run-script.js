...
function spawnScript() {
  ...
  const scriptIndex = args.findIndex(x => ['build', 'format', 'lint', 'test', 'validate', 'typecheck'].includes(x)); // Extract the node arguments so we can pass them to node later on
