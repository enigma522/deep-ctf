...
var buttonVariants = cva("inline-flex items-center justify-center whitespace-nowrap  text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50", {
  variants: {
    variant: {
      ...
      ibm_blue: "bg-[#0043ce] text-primary-foreground hover:bg-[#002d9c]/90 shadow-md fold-bold px-3 py-1",
      ibm_green: "bg-[#198038] text-primary-foreground hover:bg-[#6fdc8c]/95 hover:text-black shadow-lg",
      ibm_teal: "bg-[#007d79] text-primary-foreground hover:bg-[#9ef0f0]/90 shadow-md",
      submit_button: "shadow-md fold-bold relative inline-block h-full w-full rounded border-2 border-black bg-white px-3 py-1 text-base font-bold text-black transition duration-100 hover:bg-[#6fdc8c] hover:text-gray-900 ",
      submit_button2: "fold-bold relative inline-block h-full w-full rounded border-2 border-black bg-black px-3 py-1 text-base font-bold text-white transition duration-100 hover:bg-gray-900 hover:text-yellow-50 shadow-md"
    },
    size: {
...
//# sourceMappingURL=/build/_shared/chunk-OCIN7GG6.js.map
