...
// app/components/projectoverview.tsx
var import_react3 = __toESM(require_react());

// app/assets/tree.svg
var tree_default = "/build/_assets/tree-7KBVBKQE.svg";
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/DataVisualization.tsx"' + id);
  };
...
var DataVisualization = ({
  ...
  (0, import_react.useEffect)(() => {
    if (chartRef.current) {
      const data = {
        datasets: [{
          ...
          backgroundColor: stages.map((stage) => {
            return stage.transportMethod === "truck" ? "rgba(29, 149, 39, 0.2)" : "rgba(54, 162, 235, 0.2)";
          }),
          borderColor: "rgba(54, 162, 235, 1)",
          borderWidth: 1,
          data: stages.map((stage) => stage.emission || 0)
        }],
        labels: stages.map((stage, index2) => {
          return `Stage ${index2 + 1}- ${stage.usesAddress ? "from " + stage.from.city + " " + stage.from.country + " to  " + stage.to.city + " " + stage.to.country : stage.distance} - ${stage.transportMethod}`;
        })
      };
      const options = {
        indexAxis: "y",
      ...
      const chart = new auto_default(chartRef.current, {
        type: "bar",
        data,
        options
      });
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("canvas", { ref: chartRef, className: " m-auto block", width: "400", height: "200" }, void 0, false, {
    fileName: "app/components/DataVisualization.tsx",
    lineNumber: 68,
    columnNumber: 10
  }, this);
};
_s(DataVisualization, "X+1SfQQ6xefXNU27aQW843M7cTw=");
_c = DataVisualization;
var DataVisualization_default = DataVisualization;
var _c;
$RefreshReg$(_c, "DataVisualization");
...
function sortAndMapPluginToOptions(plugins2) {
  return plugins2.concat().sort((a, b) => a.name > b.name ? 1 : -1).map((plugin) => plugin.options);
}
...
function EventStore() {
  ...
  function add(node, type, handler, options = {
    ...
    if ("addEventListener" in node) {
      ...
      removeListener2 = () => node.removeEventListener(type, handler, options);
    } else {
      const legacyMediaQueryList = node;
      legacyMediaQueryList.addListener(handler);
      removeListener2 = () => legacyMediaQueryList.removeListener(handler);
    }
    listeners.push(removeListener2);
    return self;
  }
  function clear() {
...
function Animations2(ownerDocument, ownerWindow, update, render) {
...
function Engine(root, container, slides, ownerDocument, ownerWindow, options, eventHandler) {
  ...
  const animation = Animations2(ownerDocument, ownerWindow, () => update(engine), (lagOffset) => render(engine, lagOffset));
  const friction = 0.68;
...
function PluginsHandler(optionsHandler) {
  let activePlugins = [];
  function init(emblaApi, plugins2) {
    activePlugins = plugins2.filter(({
      options
    }) => optionsHandler.optionsAtMedia(options).active !== false);
    activePlugins.forEach((plugin) => plugin.init(emblaApi, optionsHandler));
    return plugins2.reduce((map3, plugin) => Object.assign(map3, {
      [plugin.name]: plugin
    }), {});
  }
  function destroy() {
...
// node_modules/embla-carousel-react/esm/embla-carousel-react.esm.js
function useEmblaCarousel(options = {}, plugins2 = []) {
  const storedOptions = (0, import_react2.useRef)(options);
  const storedPlugins = (0, import_react2.useRef)(plugins2);
  const [emblaApi, setEmblaApi] = (0, import_react2.useState)();
  const [viewport, setViewport] = (0, import_react2.useState)();
  const reInit = (0, import_react2.useCallback)(() => {
    if (emblaApi)
  ...
  (0, import_react2.useEffect)(() => {
    if (arePluginsEqual(storedPlugins.current, plugins2))
      return;
    storedPlugins.current = plugins2;
    reInit();
  }, [plugins2, reInit]);
...
_s2(useCarousel, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var Carousel = _s22(React2.forwardRef(_c2 = _s22(({
  ...
  const [scrollSnaps, setScrollSnaps] = React2.useState([]);
  const onDotButtonClick = React2.useCallback((index2) => {
    if (!api)
      return;
    api.scrollTo(index2);
  }, [api]);
  const onInit = React2.useCallback((api2) => {
    if (!api2) {
      return;
    }
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(CarouselContext.Provider, { value: {
    carouselRef,
    api,
    opts,
    ...
    scrollSnaps,
    onDotButtonClick
  }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { ref, onKeyDownCapture: handleKeyDown, className: cn("relative", className), role: "region", "aria-roledescription": "carousel", ...props, children }, void 0, false, {
...
}, "rxI+3Pp28higQ2QKrdZ+nicQhQY=", false, function() {
...
var CarouselContent = _s3(React2.forwardRef(_c3 = _s3(({
  className,
  ...props
}, ref) => {
  _s3();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { ref: carouselRef, className: "overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { ref, className: cn("flex", orientation === "horizontal" ? "" : "flex-col", className), ...props }, void 0, false, {
    fileName: "app/components/ui/carousel.tsx",
    lineNumber: 147,
    columnNumber: 7
  }, this) }, void 0, false, {
...
var CarouselItem = _s4(React2.forwardRef(_c5 = _s4(({
  className,
  ...props
}, ref) => {
  _s4();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { ref, role: "group", "aria-roledescription": "slide", className: cn("min-w-0 shrink-0 grow-0 basis-full", orientation === "horizontal" ? "pl-4" : "pt-4", className), ...props }, void 0, false, {
    fileName: "app/components/ui/carousel.tsx",
    lineNumber: 164,
    columnNumber: 10
  }, this);
...
var CarouselPrevious = _s5(React2.forwardRef(_c7 = _s5(({
  className,
  variant,
  size,
  children,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button, { ref, variant, size, className, disabled: !canScrollPrev, onClick: scrollPrev, ...props, children }, void 0, false, {
    fileName: "app/components/ui/carousel.tsx",
    lineNumber: 184,
    columnNumber: 10
  }, this);
...
var CarouselNext = _s6(React2.forwardRef(_c9 = _s6(({
  className,
  variant,
  size,
  children,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button, { ref, variant, size, className, disabled: !canScrollNext, onClick: scrollNext, ...props, children }, void 0, false, {
    fileName: "app/components/ui/carousel.tsx",
    lineNumber: 206,
    columnNumber: 10
  }, this);
...
var DotButton = React2.forwardRef(_c11 = ({
  className,
  children,
  ...props
}, ref) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("button", { type: "button", className, ...props, children }, void 0, false, {
    fileName: "app/components/ui/carousel.tsx",
    lineNumber: 221,
    columnNumber: 10
  }, this);
...
_c12 = DotButton;
var CarouselPagination = _s7(React2.forwardRef(_c13 = _s7(({
  className,
  ...props
}, ref) => {
  _s7();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex flex-wrap justify-start items-center mr-[calc((2.6rem-1.4rem)/2*-1)] gap-4", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("h4", { children: "Select Route:" }, void 0, false, {
      fileName: "app/components/ui/carousel.tsx",
      lineNumber: 237,
      columnNumber: 7
    }, this),
    scrollSnaps.map((_, index2) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(DotButton, { onClick: () => onDotButtonClick(index2), className: "p-0 w-5 h-5 flex text-sm items-center justify-center rounded-full cursor-pointer button-2 outline-dashed ".concat(index2 === selectedIndex ? " outline-green-500  " : "outline-slate-800"), children: index2 + 1 }, index2, false, {
      fileName: "app/components/ui/carousel.tsx",
      lineNumber: 238,
      columnNumber: 38
    }, this))
...
}, "kZNJJfGo9dcp25CEOUxf+pTbJcY=", false, function() {
  return [useCarousel];
})), "kZNJJfGo9dcp25CEOUxf+pTbJcY=", false, function() {
  return [useCarousel];
});
_c14 = CarouselPagination;
...
var _c13;
var _c14;
$RefreshReg$(_c2, "Carousel$React.forwardRef");
$RefreshReg$(_c22, "Carousel");
...
$RefreshReg$(_c11, "DotButton$React.forwardRef");
$RefreshReg$(_c12, "DotButton");
$RefreshReg$(_c13, "CarouselPagination$React.forwardRef");
$RefreshReg$(_c14, "CarouselPagination");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/projectoverview.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
var ProjectOverview = ({
  ...
  _s8();
  const [calcChain, setCalcChain] = (0, import_react3.useState)(loadChain(project.chain));
  const [titleProject, setTitleProject] = (0, import_react3.useState)(project.title);
  const [message, setMessage] = (0, import_react3.useState)("");
  const [descriptionProject, setDescriptionProject] = (0, import_react3.useState)(project.description);
  const fetcher = useFetcher();
  const handleUpdateProject = () => {
    if (calcChain.emission != project.chain.emission || calcChain.routes.length != project.chain.routes.length) {
      const project_ = {
        projId: project.id,
        title: titleProject,
        descriptionProject,
  ...
  const handleDownload = () => {
    const settings = {
      ...
      writeMode: "writeFile",
      // The available parameters are 'WriteFile' and 'write'. This setting is optional. Useful in such cases https://docs.sheetjs.com/docs/solutions/output#example-remote-file
      writeOptions: {}
    ...
    const data = project.chain.routes.map((route) => {
      return {
        ...
        columns: [{
          ...
          label: "Amount of co2 in kg",
          value: "amount_of_CO2"
        }],
        content: route.stages.map((stage) => {
          return {
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex flex-col justify-center items-center", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Carousel, { className: "w-full", orientation: "horizontal", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CarouselContent, { className: "max-w-full", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CarouselItem, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex flex-col justify-between items-center gap-4", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Card, { className: "w-full max-w-md md:max-w-2xl", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CardHeader, { children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CardTitle, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("h1", { children: project.title }, void 0, false, {
                fileName: "app/components/projectoverview.tsx",
                lineNumber: 116,
                columnNumber: 21
              }, this) }, void 0, false, {
                fileName: "app/components/projectoverview.tsx",
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CardDescription, { children: project.description }, void 0, false, {
                fileName: "app/components/projectoverview.tsx",
                lineNumber: 118,
                columnNumber: 19
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("img", { src: tree_default, alt: "IBM Logo", className: "h-40" }, void 0, false, {
                fileName: "app/components/projectoverview.tsx",
                lineNumber: 119,
                columnNumber: 19
              }, this)
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CardContent, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Carousel, { children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CarouselContent, { children: project.routes.map((route) => /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CarouselItem, { children: [
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Carousel, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CarouselContent, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(DataVisualization_default, { stages: route.stages }, void 0, false, {
                  fileName: "app/components/projectoverview.tsx",
                  lineNumber: 178,
                  columnNumber: 31
                }, this) }, void 0, false, {
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CarouselPagination, {}, void 0, false, {
                fileName: "app/components/projectoverview.tsx",
                lineNumber: 183,
                columnNumber: 21
              }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CarouselNext, { children: "Edit Chain" }, void 0, false, {
            fileName: "app/components/projectoverview.tsx",
            lineNumber: 187,
            columnNumber: 15
          }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CarouselItem, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex flex-col justify-between items-center gap-4 h-full", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Calculator_default, { isProject: true, chain: calcChain, setChain: setCalcChain }, void 0, false, {
            fileName: "app/components/projectoverview.tsx",
            lineNumber: 195,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CarouselPrevious, { children: "View Graphs" }, void 0, false, {
            fileName: "app/components/projectoverview.tsx",
            lineNumber: 196,
            columnNumber: 15
          }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(CardFooter, { className: "pt-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex gap-4 flex-col w-full", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Button, { onClick: handleDownload, children: "Download as Spreadsheet" }, void 0, false, {
          fileName: "app/components/projectoverview.tsx",
          lineNumber: 206,
          columnNumber: 11
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Button, { className: "border-black border rounded", variant: "ibm_green", onClick: handleUpdateProject, children: "Save Project Changes" }, void 0, false, {
          fileName: "app/components/projectoverview.tsx",
          lineNumber: 207,
          columnNumber: 11
        }, this),
        message != "" && /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "bg-green-200 p-3 mb-3 rounded-md text-green-800", children: message }, void 0, false, {
          fileName: "app/components/projectoverview.tsx",
          lineNumber: 210,
          columnNumber: 29
        }, this)
...
_s8(ProjectOverview, "T22VNkTqizFv8ZLBLtLaxJ7yfvQ=", false, function() {
  return [useFetcher];
});
_c15 = ProjectOverview;
var projectoverview_default = ProjectOverview;
var _c15;
$RefreshReg$(_c15, "ProjectOverview");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;

// app/routes/projects.$title.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/projects.$title.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
var ProjectById = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(projectoverview_default, { project }, void 0, false, {
    fileName: "app/routes/projects.$title.tsx",
    lineNumber: 61,
    columnNumber: 10
  }, this);
};
_s9(ProjectById, "mHQaN3+RSDej8LY8G1VwjFF7KAE=", false, function() {
  return [useLoaderData];
});
_c16 = ProjectById;
var projects_title_default = ProjectById;
var _c16;
$RefreshReg$(_c16, "ProjectById");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  projects_title_default as default
};
...
chart.js/dist/chart.js:
   ...
   *)
*/
//# sourceMappingURL=/build/routes/projects.$title-J4N5T4VA.js.map
